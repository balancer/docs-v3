...
This is achieved by utilizing two core components:
1. [Rate provider](../rate-providers.md) technology
2. [Boosted pools](../products/boostedpools.md)
...
- [Go here](/partner-onboarding/balancer-v2/onboard-yb-token) if you want to onboard your liquidity to Balancer v2. Much of this is the same for v3.
