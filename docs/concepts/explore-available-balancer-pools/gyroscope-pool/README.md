...
- [Gyro 2-CLP](./gyro-2clp.md): Quadratic concentrated liquidity pools concentrate liquidity within a pricing range. A given 2-CLP is parameterized by the pricing range [α,β], and the two assets in the pool.
